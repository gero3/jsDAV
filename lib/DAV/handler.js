...
(function() {
    ...
    this.httpPropfind = function() {
        var self = this;
		console.log("httpPropfind started");
    ...
    this.getRequestUri = function() {
		console.log("handler.js:getRequestUri()");
    ...
    this.calculateUri = function(uri) {
        ...
        uri = uri.replace("//", "/");
		console.log(uri, this.server.baseUri,uri.indexOf(this.server.baseUri));
    ...
    this.getPropertiesForPath = function(path, propertyNames, depth, cbgetpropspath) {
        ...
        var self               = this;
		console.log("getPropertiesForPath: handler.js");
    ...
    this.createFile = function(uri, data, enc, cbcreatefile) {
        ...
        this.dispatchEvent("beforeBind", uri, function(stop) {
            if (stop === true)
                return cbcreatefile();
            self.dispatchEvent("beforeCreateFile", uri, data, enc, function(stop) {
                if (stop === true)
                    return cbcreatefile();
